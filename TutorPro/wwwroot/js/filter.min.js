function sendRequest(n=null,t=null,i=1){var r=$("#subject").siblings(".new-select__list").find(".new-select__item.selected").attr("data-value"),u=$("#grade").siblings(".new-select__list").find(".new-select__item.selected").attr("data-value"),f=$("#level").siblings(".new-select__list").find(".new-select__item.selected").attr("data-value"),e=$("#sort").siblings(".new-select__list").find(".new-select__item.selected").attr("data-value"),o=document.getElementsByClassName("filter-form__input")[0].value,s,h;if(n!==null&&t!==null)switch(n){case"subject":r=t;break;case"grade":u=t;break;case"level":f=t;break;case"sort":e=t;break;case"search":o=t}s=document.querySelector(".matirials__pagination");h=s.getAttribute("data-pageSize");$.ajax({url:"/Umbraco/Api/Materials/GetMaterials",method:"GET",data:{subject:r,grade:u,level:f,sort:e,page:i,pageSize:h,searchText:o},success:function(n){updateContent(n)},error:function(n,t,i){console.error(i)}})}function updateContent(n){var t,i,r;$(".matirials__block").empty();t=document.querySelector("[data-articleUrl]");i=t.getAttribute("data-articleUrl");n.materials&&n.materials.length>0?n.materials.forEach(function(n){var t=`
            ...
            `;$(".matirials__block").append(t)}):(r=$(".matirials__block").attr("data-notFoundMessage"),$(".matirials__block").html(`<h1 style="width: 100%; text-align: center;">${r}</h1>`));updatePagination(n)}function updatePagination(n){var t,i,r;for($(".pagination__list").empty(),t=1;t<=n.totalPages;t++)i=t===n.currentPage?"active":"",r=`<li class="pagination__list-item"><a class="pagination__list-link ${i}" href="#">${t}</a></li>`,$(".pagination__list").append(r)}$(document).ready(function(){sendRequest();$(".filter-form__select").on("change",function(){sendRequest()});let n,t=document.querySelector("[data-searchDelay]"),i=t.getAttribute("data-searchDelay");document.querySelector(".filter-form__input").addEventListener("input",function(){clearTimeout(n);let t=this.value;n=setTimeout(function(){sendRequest("search",t)},i)});$(".pagination__list").on("click",".pagination__list-link",function(n){n.preventDefault();var t=$(this).text();sendRequest(null,null,t)})});