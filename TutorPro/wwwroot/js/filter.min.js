function sendRequest(n=null,t=null,i=1){var u=$("#sort").siblings(".new-select__list").find(".new-select__item.selected").attr("data-value"),f=document.getElementsByClassName("filter-form__input")[0].value,e,o;if(n!==null&&t!==null)switch(n){case"grade":grade=t;break;case"level":level=t;break;case"sort":u=t;break;case"search":f=t}e=document.querySelector(".matirials__pagination");o=e.getAttribute("data-pageSize");const r=document.getElementById("materials_filter"),s=r.getAttribute("data-language"),h=r.getAttribute("data-subject"),c=r.getAttribute("data-pageId");$.ajax({url:"/Umbraco/Api/Materials/GetMaterials",method:"POST",contentType:"application/json; charset=utf-8",headers:{Accept:"application/json"},data:JSON.stringify({subject:h,language:s,categoryItems:getCategories(),sort:u,page:i,pageSize:o,pageId:c,searchText:f}),success:function(n){updateContent(n)},error:function(n,t,i){console.error(i)}})}function getSelectedItemsByCategory(n){const t=`.selected[data-categorie="${n}"]`;return document.querySelectorAll(t)}function getSelectedKeysByCategory(n){const t=getSelectedItemsByCategory(n);return Array.from(t).map(n=>n.getAttribute("data-key"))}function updateContent(n){var t,i,r;$(".matirials__block").empty();t=$(".matirials__block").attr("data-reviews");i=$(".matirials__block").attr("data-culture");n.materials&&n.materials.length>0?n.materials.forEach(function(n){const r=Math.floor(Math.random()*4)+1,u=new Date(n.updatedDate),f=u.toLocaleDateString(`${i}`,{year:"numeric",month:"long",day:"numeric"});var e=`
